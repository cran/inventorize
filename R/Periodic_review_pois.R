...
Periodic_review_pois<- function(demand,lambda,leadtime,service_level,Review_period,
  ...
  message('this function is deprecated, kindly use periodic_policy() instead')
